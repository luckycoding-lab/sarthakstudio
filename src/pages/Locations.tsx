...
const locationData = [
  {
    ...
    weddings: "150+",
    testimonial:
      '"Sarthak made our sangeet night absolutely magical!" - Priya S.',
    rating: 4.9,
    color: "#daa520",
  },
  {
    name: "Gurgaon",
    area: "DLF, Sohna Road, Sector 14-57, Golf Course Road, MG Road",
    weddings: "120+",
    testimonial:
      '"Best choreographer in Gurgaon. Our group dance was a hit!" - Rahul M.',
    rating: 4.9,
    color: "#008080",
  },
  {
    name: "Noida",
    area: "Sector 18, Greater Noida West, Sector 62, Film City area",
    weddings: "80+",
    testimonial:
      '"Perfect for our couple dance. So patient and creative!" - Sneha & Arun',
    rating: 4.8,
    color: "#4b0032",
  },
  {
    name: "Faridabad",
    area: "Sector 15-21, NIT, Ballabgarh, Old Faridabad",
    weddings: "60+",
    testimonial:
      '"Travelled to our home and taught the whole family!" - Geeta J.',
    rating: 4.9,
    color: "#b8860b",
  },
  {
    name: "Greater Noida",
    area: "Alpha, Beta, Gamma, Knowledge Park, Pari Chowk",
    weddings: "40+",
    testimonial: '"Made even grandparents comfortable dancing!" - Anil K.',
    rating: 4.8,
    color: "#006060",
  },
  {
    name: "Ghaziabad",
    area: "Indirapuram, Vaishali, Kaushambi, Raj Nagar Extension",
    weddings: "50+",
    testimonial: '"Our bride solo was the talk of the wedding!" - Meera R.',
    rating: 4.9,
    color: "#600040",
  },
];
...
export default function Locations() {
  ...
  return (
    <div ref={ref}>
      ...
      {/* Interactive Map */}
      <section
        style={{ padding: "clamp(60px, 8vw, 150px)", background: "white" }}
      >
